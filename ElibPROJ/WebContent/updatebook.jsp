...
<div class="fixed-header">
	...
	<form name="RegForm" class ="box2" action="BookController.do?action=update" onsubmit="return formValidation()" method="post">
		<fieldset>
			<div>
			...
			<div>
				<label for="year">YEAR</label> <input type="text" name="year"
					value="<c:out value="${member.year}" />" placeholder="YEAR" />
			</div>
			<div>
